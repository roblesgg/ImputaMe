...
const TUTORIAL_STEPS = [
  ...
  { id:'main-reanudar',  window:'main', version:'2.4.1', selector:'#quickResume',
    title:'Reanudar la última', text:'Vuelve a poner en marcha la última tarea que estuviste haciendo, sin buscarla en la lista. El botón te dice cuál es.' },
  { id:'main-imputar',   window:'main', version:'2.4.1', selector:'#imputeBtn',
    title:'Imputar', text:'Te lleva al sitio donde metes las horas de verdad. Sale aquí en cuanto pegas su dirección en Ajustes → Enlace para imputar.' },
  ...
  { id:'cal-menu',       window:'calendar', version:'2.4.6', selector:'#gridScroll',
  ...
  { id:'grp-todas',      window:'groups', version:'2.5.5', selector:'#groupsList',
    title:'Aquí están todas', text:'Esta pestaña ya no es solo el archivo: están todas tus tareas. Las que no pertenecen a ninguna sección salen agrupadas al principio, para que las repartas cuando quieras.' },
  { id:'grp-fila',       window:'groups', version:'2.5.5', selector:'#groupsList .archived-task-row',
    title:'Cada tarea, a mano', text:'Su punto de color lo cambia, el lápiz la renombra, el play la pone en marcha (la saca del archivo sola si hacía falta) y la papelera la elimina. La que esté corriendo se ve resaltada, con su punto latiendo.' },
